...
```{r load}
eset.cohort1<-readRDS("H:/analyses/Course_Intro_to_EWAS/results/QC/subsets/GSE42861_norm_cohort1bis.Rds") 
...
## Run EWAS
### Data preparation
Here we will show an example to run the analysis testing current smokers against 
never smokers. Nevertheless, the same code can be applied to run other
