...
A file with the theory can be downloaded [here](./Slides/ISG_summer_school_EWAS3.pptx)
...
and also 3) adjusting by the surrogate variables to correct the batch (noise)
```{r summary2}
...
The plot that you should obtain can be found [here](./../data/DAY3/Output/VolcanoPlot.EWAS.cohort1.NeverVScurrent)
...
The plot that you should obtain can be found [here](./../data/DAY3/Output/ManhattanPlot.EWAS.cohort1.NeverVScurrent)
